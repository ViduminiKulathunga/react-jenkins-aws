pipeline {
    ...
    stages {
        ...
        stage("Prod E2E") {
            ...
            post {
                always {
                    publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, icon: '', keepAll: false, reportDir: 'playwright-report', reportFiles: 'index.html', reportName: 'Playwrite E2E HTML Report', reportTitles: '', useWrapperFileDirectly: true])
                }
            }
        }
    }
